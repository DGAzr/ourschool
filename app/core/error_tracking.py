...
class ErrorTracker:
    ...
    def _determine_severity(self, error: Exception) -> str:
        ...
        if any(
            ...
            for keyword in ["auth", "permission", "credential"]
        ):
            return "medium"
...
class ErrorHandler:
    ...
    async def general_exception_handler(
        ...
        error_id = track_error(
            exc, request=request, user_id=user_id, context={"unexpected": True}
        )
...
class PermissionError(HomeschoolBusinessError):
    ...
    def __init__(
        self, message: str, required_permission: str = None, user_role: str = None
    ):
