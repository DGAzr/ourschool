        ...
        <>
          ...
          <div className="flex gap-4 flex-1 min-h-0">
              ...
              <div className="flex-1 overflow-y-auto p-2 space-y-1">
                {queueItems.length === 0 ? (
                  ...
                  return (
                    <button
                      key={a.id}
                      onClick={() => { setSelectedQueueId(a.id); setGradeInput(''); setFeedbackInput('') }}
            ...
            <div className="flex-1 bg-panel border border-line rounded-card flex flex-col min-h-0 overflow-y-auto">
              {!selectedAssignment ? (
                <div className="flex-1 flex flex-col items-center justify-center gap-3 text-center px-10 text-faint">
